    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_capacity', models.CharField(choices=[('single', 'Single'), ('double', 'Double'), ('triple', 'Triple'), ('quadruple', 'Quadruple')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comment_images', to='room.room')),
            ],
        ),
        migrations.CreateModel(
            name='RoomImage',
